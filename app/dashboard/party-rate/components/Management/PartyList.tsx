...
export default function PartyList({
    ...
    isMobile, onViewProfile, onViewRates, onEditProfile, onDelete, onCreate
}: PartyListProps) {
    ...
    return (
        <div style={{ animation: "fadeIn 0.3s ease-out", maxWidth: "100%", overflowX: "hidden" }}>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 20, gap: 10, flexWrap: "wrap" }}>
                <div>
                    <h2 style={{ fontSize: isMobile ? 18 : 20, fontWeight: 500, color: "#0f172a", margin: 0 }}>Party Wise Rate</h2>
                    <p style={{ fontSize: isMobile ? 12 : 13, color: "#64748b", margin: "4px 0 0" }}>Manage customer-specific product pricing and profiles</p>
                </div>
                {onCreate && (
                    <button 
                        onClick={onCreate}
            ...
            <div style={{ 
                ...
                padding: isMobile ? "10px 12px" : "12px 16px", background: "#fff", border: "1.5px solid #e2e8f0",
                borderRadius: 14, boxShadow: "0 1px 2px rgba(0,0,0,0.03)"
            }}>
                <svg width={isMobile ? 16 : 18} height={isMobile ? 16 : 18} viewBox="0 0 24 24" fill="none" stroke="#94a3b8" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
                ...
                <input
                    ...
                    style={{ border: "none", outline: "none", boxShadow: "none", background: "transparent", width: "100%", fontSize: isMobile ? 13 : 14, color: "#1e293b" }}
                />
            </div>
                ...
                <div style={{ 
                    ...
                    {filteredRates.map(pr => (
                        <Card 
                            key={pr.id} 
                            style={{ 
                                padding: isMobile ? 16 : 20, cursor: "pointer", border: "1px solid #e2e8f0",
