...
function getNavGroups(userData: any): NavGroup[] {
    const groups: NavGroup[] = [
        ...
        },
        {
            ...
            items: [
                { id: "rapid-dispatch", label: "Create Dispatch", permKey: "ecom_dispatch_create" },
                { id: "create-dispatch", label: "Step-by-Step Dispatch", permKey: "ecom_dispatch_create" },
                { id: "order-list", label: "All Dispatches", permKey: "ecom_dispatch_view" },
            ],
            permKey: "ecom_dispatch_view"
        },
        {
            ...
            items: [
                { id: "add-order", label: "Add Unknown Order", permKey: "ecom_dispatch_create" },
                { id: "scanner", label: "Scan Barcode", permKey: "ecom_box_view" },
...
export default function DispatchSidebar({
    ...
    const activeGroup = navGroups.find(g => g.items.some(i => i.id === activeView))?.key || "dispatch";
